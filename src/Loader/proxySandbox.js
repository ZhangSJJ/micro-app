...
const variableWhiteListInDev = process.env.NODE_ENV === 'development' || window.__QIANKUN_DEVELOPMENT__
    ? [
...
export default class ProxySandbox {
    constructor(name, globalContext = window) {
        ...
        const hasOwnProperty = (key) => fakeWindow.hasOwnProperty(key) || globalContext.hasOwnProperty(key);
